            ...
            <div class="col-sm-12 col-md-12 col-lg-6 parte-formulario pt-5">
                ...
                <form action="<?php echo base_url(); ?>contacto" method="post">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <input type="text" name="apellido" placeholder="apellido" value="" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="col-12 ">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input type="text" name="asunto" placeholder="asunto" value="" class="form-control">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input type="text" name="mensaje" placeholder="mensaje" value="" class="form-control">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
